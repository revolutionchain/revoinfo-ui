      ...
      <div class="column is-half">
        <div class="card">
          <div class="card-header">
            ...
            <nuxt-link to="/block" class="card-header-button button is-revo is-outlined">
              {{ $t('action.view_all') }}
            </nuxt-link>
          </div>
          <div class="card-body">
            <div v-for="block in recentBlocks" class="revo-block is-size-7" :key="block.hash">
              <div class="level">
                  ...
                  <div class="level-item">
                    <div>
                      ...
                      <span class="monospace">
                        {{ $t('block.brief.reward') }} {{ block.reward | revo }} RVO
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div class="card-body">
            <div v-for="transaction in recentTransactions" :key="transaction.id" class="is-size-7 transaction">
              <div class="level">
                ...
                <span class="level-right">{{ transaction.outputValue | revo }} RVO</span>
              </div>
            </div>
          </div>
        </div>
